            ...
            <ol class="lg:col-span-8 divide-y divide-white/10">
                <?php foreach ($axioms as $axiom): ?>
                    <li class="py-6 first:pt-0 last:pb-0 reveal active">
                        <a href="/framework.php#axiom-<?php echo e($axiom['number']); ?>" class="group grid sm:grid-cols-[5rem_1fr] gap-2 sm:gap-8 items-baseline">
                            <span class="font-display font-black text-4xl text-brand-gold leading-none"><?php echo e($axiom['number']); ?></span>
                    ...
                    <div class="grid sm:grid-cols-2 gap-8">
                        <?php foreach ($recentPosts as $post): ?>
                            <a href="/post.php?slug=<?php echo e($post['slug']); ?>" class="group block">
                                ...
                                <h3 class="serif text-xl font-bold text-brand-black group-hover:text-brand-gold transition-colors mb-2"><?php echo e($post['title']); ?></h3>
                                <p class="text-sm text-brand-gray-600 font-light leading-relaxed"><?php echo e($post['excerpt']); ?></p>
