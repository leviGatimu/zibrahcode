...
<main class="pt-16 lg:pt-40 pb-16 md:pb-24 px-8 md:px-16 max-w-7xl mx-auto">
    ...
    <div class="lg:grid lg:grid-cols-3 lg:gap-x-16 lg:items-start">
        ...
        <?php if ($related): ?>
            <aside class="mt-12 lg:mt-0 pt-16 lg:pt-0 border-t lg:border-t-0 border-brand-gray-100 reveal active lg:col-start-3 lg:row-start-1 lg:row-span-2 lg:sticky lg:top-32">
